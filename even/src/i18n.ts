...
const STRINGS = {
  ...
  ob2Desc:        { en: 'Speechmatics is used to transcribe your voice. If you don\'t have a key yet, sign up free (480 min/month) at portal.speechmatics.com.',
                    ja: '音声を文字に変換するために Speechmatics の API key を使います。まだ持っていなければ portal.speechmatics.com で無料登録 (月480分まで無料)。' },
